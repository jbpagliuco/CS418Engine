...
namespace CS418
{
	...
	Matrix MatrixRotationQuaternion(const Quaternion & qRot)
	{
		...
		CS418_ALIGN_MS(16) F32 col0[4] CS418_ALIGN_GCC(16) = { 1 - yy2 - zz2, xy2 - zw2, xz2 + yw2, 0.0f };
		CS418_ALIGN_MS(16) F32 col1[4] CS418_ALIGN_GCC(16) = { xy2 + zw2, 1 - xx2 - zz2, yz2 - xw2, 0.0f };
		CS418_ALIGN_MS(16) F32 col2[4] CS418_ALIGN_GCC(16) = { xz2 - yw2, yz2 + xw2, 1 - xx2 - yy2, 0.0f };
